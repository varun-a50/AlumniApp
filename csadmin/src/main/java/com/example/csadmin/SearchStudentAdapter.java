...
public class SearchStudentAdapter extends FirebaseRecyclerAdapter<Student, SearchStudentAdapter.ViewHolder> {
    Context context;


    public SearchStudentAdapter(@NonNull FirebaseRecyclerOptions<Student> options, Context context) {
        super(options);
