...
public class Profile_upload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageProfilePicsRef = FirebaseStorage.getInstance().getReference().child("Alumnis");
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Profile_upload.this);
                        ...
                        FirbaseUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Alumnis");
                                    databaseReference.child(FirbaseUser.getUid()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {

                                            Intent intent = new Intent(Profile_upload.this,Registration.class);
    ...
    private void Userinfo() {
        ...
        StorageReference photoReference= storageReference.child("Alumnis/Profiles/*"+alumniID);
    ...
    private void uploadProfileImage() {
        ...
        if (imageUri != null) {
            ...
            StorageReference mountainRef = storageProfilePicsRef.child("Profiles/*" + alumniID);
