...
public class Profile_upload_students extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_upload_students);
        ...
        storageProfilePicsRef = FirebaseStorage.getInstance().getReference().child("Students");
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Profile_upload_students.this);
                                ...
                                if (task.isSuccessful()){
                                    ...
                                    databaseReference.child(FirbaseUser.getUid()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            Intent intent = new Intent(Profile_upload_students.this,Student_registration.class);
    ...
    private void Userinfo() {
        ...
        StorageReference photoReference= storageReference.child("Students/Profiles/*"+studentID);
    ...
    private void uploadProfileImage() {
        ...
        if (imageUri != null) {
            ...
            StorageReference mountainRef = storageProfilePicsRef.child("Profiles/*" + studentID);
